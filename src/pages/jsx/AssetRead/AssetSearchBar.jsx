...
const SearchForm = ({ onSearch }) => {
	...
	return (
		<div
			style={{
				border: '1px solid #ccc', // 실선의 색상
				borderRadius: '8px', // 둥근 모서리
				backgroundColor: '#cce7ff', // 옅은 파란색 배경
				padding: '16px', // 여백 추가
			...
			<RHForm onChange={handleFormChange}>
				<Row className="mb-4">
					...
					<Col md={3} className="d-flex align-items-center">
						<Form.Label className="me-2 mb-0 text-center" style={{ width: '40%' }}>
							자산명
						</Form.Label>
						<Form.Control
							name="assetName"
					...
					<Col md={3} className="d-flex align-items-center">
						...
						<Select
							options={assetLocationOptions} // assetLocation 값을 options으로 사용
							value={selectedAssetLocation}
							onChange={handleAssetLocationChange} // 선택된 값을 처리
							placeholder="자산 위치를 선택하세요..."
							styles={customSelectStyles} // 스타일 적용
						/>
					</Col>
					<Col md={3} className="d-flex align-items-center">
						<Form.Label className="me-2 mb-0 text-center" style={{ width: '40%' }}>
				...
				<Row className="mb-1">
					...
					<Col md={4} className="d-flex align-items-center">
						<Form.Label
							...
							className="me-2 mb-0 text-center"
							style={{ width: '20%' }} // Label 너비 조정
						>
							취득일자
						</Form.Label>
						<Row>
