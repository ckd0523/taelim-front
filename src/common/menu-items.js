	...
	},
	{
		...
		children: [
			...
			},
			{
				key: 'ds-Expand-ITS',
				label: '정보보호시스템',
				url: '/jsx/Expand/INFORMATION_PROTECTION_SYSTEM',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-APP',
				label: '응용프로그램',
				url: '/jsx/Expand/APPLICATION_PROGRAM',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-SFT',
			...
			},
			{
				key: 'ds-Expand-EIN',
				label: '전자정보',
				url: '/jsx/Expand/ELECTRONIC_INFORMATION',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-DOC',
				label: '문서',
				url: '/jsx/Expand/DOCUMENT',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-PAT',
				label: '특허 및 상표',
				url: '/jsx/Expand/PATENTS_AND_TRADEMARKS',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-ITE',
				label: 'IT 장비 - 시스템',
				url: '/jsx/Expand/ITSYSTEM_EQUIPMENT',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-ITN',
				label: 'IT 장비 – 네트워크',
				url: '/jsx/Expand/ITNETWORK_EQUIPMENT',
				parentKey: 'check',
			},
			{
				key: 'ds-Expand-TER',
				label: '단말기',
				url: '/jsx/Expand/TERMINAL',
				parentKey: 'check',
			},
			{
