		...
		<Card>
			<Card.Body>
				...
				<div className="button-list d-flex flex-wrap gap-2">
					...
					<Button onClick={() => openModalWithClass('modal-full-width')}>
						Full width Modal
					</Button>
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted">
					...
					or right of page by specifying classes <code>modal-top</code>,
					<code>modal-bottom</code>, <code>modal-dialog-centered</code> and
		...
		<Card>
			<Card.Body>
				...
				<Modal show={isOpen} onHide={toggleModal}>
					...
					<Modal.Body
						className={classNames('modal-filled', 'bg-' + className, 'text-light')}
					>
						<p>
							Cras mattis consectetur purus sit amet fermentum. Cras justo odio,
							dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac
