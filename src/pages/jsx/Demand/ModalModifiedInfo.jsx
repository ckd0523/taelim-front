						...
						<th>자산명</th> */}
								...
								<tbody>
									<tr>
										...
										>
											{modifiedAssetInfo.productSerialNumber || 'N/A'}
										</td>
										<td
											className={getCellClassName(
							...
							<BootstrapTable bordered className="table-update">
								...
								<tbody>
									<tr>
										...
										>
											{modifiedAssetInfo.ownership || 'N/A'}
										</td>
										<td
											className={getCellClassName(
							...
							<BootstrapTable bordered className="table-update">
								...
								<tbody>
									<tr>
										...
										>
											{modifiedAssetInfo.quantity || 'N/A'}
										</td>
										<td
											className={getCellClassName(
